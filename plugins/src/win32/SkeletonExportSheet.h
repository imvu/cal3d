...
public:
	CSkeletonExportSheet(CBaseInterface* iface, UINT nIDCaption, CWnd *pParentWnd = NULL, UINT iSelectPage = 0);
	CSkeletonExportSheet(CBaseInterface* iface, LPCTSTR pszCaption, CWnd *pParentWnd = NULL, UINT iSelectPage = 0);
