...
public:
	CAnimationExportSheet(CBaseInterface* interface, UINT nIDCaption, CWnd *pParentWnd = NULL, UINT iSelectPage = 0);
	CAnimationExportSheet(CBaseInterface* interface, LPCTSTR pszCaption, CWnd *pParentWnd = NULL, UINT iSelectPage = 0);
