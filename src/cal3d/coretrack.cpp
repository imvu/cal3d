...
bool CalCoreTrack::addCoreKeyframe(CalCoreKeyframe coreKeyframe)
{
    m_keyframes.push_back(coreKeyframe);
...
bool
CalCoreTrack::roundTranslation( CalCoreKeyframe const & prev, CalCoreKeyframe & p, double transTolerance  )
{
...
{
    CalCoreKeyFrameVector::iterator iteratorCoreKeyframeBefore;
    CalCoreKeyFrameVector::iterator iteratorCoreKeyframeAfter;
    ...
    CalCoreKeyframe coreKeyframeBefore = *iteratorCoreKeyframeBefore;
    CalCoreKeyframe coreKeyframeAfter = *iteratorCoreKeyframeAfter;
    ...
    // blend between the two keyframes
    translation = coreKeyframeBefore.getTranslation();
    translation.blend(blendFactor, coreKeyframeAfter.getTranslation());

    rotation = coreKeyframeBefore.getRotation();
    rotation.blend(blendFactor, coreKeyframeAfter.getRotation());

    return true;
}

CalCoreTrack::CalCoreKeyFrameVector::iterator CalCoreTrack::getUpperBound(float time)
{
...
CalCoreKeyframe const & CalCoreTrack::getCoreKeyframe(int idx)
{
