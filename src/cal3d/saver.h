...
public:
    ...
    static bool saveCoreMesh(std::ostream& os, const std::string& optionalFilename, CalCoreMesh *pCoreMesh);  
...
private:
    static bool saveCoreBones(std::ostream& file, const std::string& strFilename, CalCoreBone *pCoreBone);
