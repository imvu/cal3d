...
public:
    static std::string saveCoreAnimationToBuffer(CalCoreAnimationPtr pCoreAnimation, bool negateW = false);
    ...
    static std::string saveCoreAnimationXmlToBuffer(CalCoreAnimationPtr pCoreAnimation, bool negateW = false);

    static bool saveCoreAnimation(const std::string& strFilename, CalCoreAnimation* pCoreAnimation, bool negateW = false);
    static bool saveCoreAnimation(std::ostream& stream, CalCoreAnimation* coreAnimation, bool negateW = false);
    ...
    static bool saveCoreSkeleton(const std::string& strFilename, CalCoreSkeleton* pCoreSkeleton, bool negateW = false);
    static bool saveCoreSkeleton(std::ostream& os, CalCoreSkeleton* pCoreSkeleton, bool negateW = false);

    static bool saveXmlCoreSkeleton(const std::string& strFilename, CalCoreSkeleton* pCoreSkeleton, bool negateW = false);
    static bool saveXmlCoreAnimation(const std::string& strFilename, CalCoreAnimation* pCoreAnimation, bool negateW = false);
    static bool saveXmlCoreAnimation(std::ostream& os, CalCoreAnimation* pCoreAnimation, bool negateW = false);
...
private:
    static bool saveCoreBone(std::ostream& file, const CalCoreSkeleton* coreSkeleton, const CalCoreBone* pCoreBone, bool negateW);
    static bool saveCoreKeyframe(std::ostream& file, const std::string& strFilename, const CalCoreKeyframe* pCoreKeyframe, bool negateW);
    static bool saveCoreSubmesh(std::ostream& file, CalCoreSubmesh* pCoreSubmesh);
    static bool saveCoreTrack(std::ostream& file, const std::string& strFilename, CalCoreTrack* pCoreTrack, bool negateW);
