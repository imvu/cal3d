...
TiXmlElement* NewTiXmlElement() {
    return xmlElementFactory_.newItem();
}
TiXmlComment* NewTiXmlComment() {
    return  xmlCommentFactory_.newItem();
}
TiXmlText* NewTiXmlText() {
    return  xmlTextFactory_.newItem();
}
TiXmlDeclaration* NewTiXmlDeclaration() {
    return  xmlDeclarationFactory_.newItem();
}
TiXmlUnknown* NewTiXmlUnknown() {
    return  xmlUnknownFactory_.newItem();
}
TiXmlDocument* NewTiXmlDocument() {
    return  xmlDocumentFactory_.newItem();
}


static ClassFactory<TiXmlAttribute, 5> xmlAttributeFactory_;
TiXmlAttribute* NewTiXmlAttribute() {
    return  xmlAttributeFactory_.newItem();
}
