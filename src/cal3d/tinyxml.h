...
class PiClassFactory {
public:
    virtual void freeItemVoid(void*) = 0;
};
...
*/
class CAL3D_API TiXmlNode : public TiXmlBase {
    friend class TiXmlDocument;
    friend class TiXmlElement;

public:
    PiClassFactory* factory_;
#ifdef TIXML_USE_STL
    ...
    */
    ...
    TiXmlUnknown*  ToUnknown() const		{
        return (this && type == UNKNOWN) ? (TiXmlUnknown*)  this : 0;    ///< Cast to a more defined type. Will return null not of the requested type.
    }
    ...
    TiXmlDeclaration* ToDeclaration() const	{
        return (this && type == DECLARATION) ? (TiXmlDeclaration*) this : 0;    ///< Cast to a more defined type. Will return null not of the requested type.
    }
...
*/
class CAL3D_API TiXmlAttribute : public TiXmlBase {
...
static int const NumAttributeBuckets = 3;
    ...
    */
    ...
    TiXmlAttribute* FirstAttribute() const	{
        for (int i = 0; i < NumAttributeBuckets; i++) {
            if (TiXmlAttribute* s = attributeBuckets[i].First()) {
                return s;
            }
        }
        return NULL;
    ...
    TiXmlAttribute* LastAttribute()	const 	{
        for (int i = 0; i < NumAttributeBuckets; i++) {
            if (TiXmlAttribute* s = attributeBuckets[i].Last()) {
                return s;
            }
        }
        return NULL;
...
private:
    TiXmlAttributeSet* attributeSetForName(char const* name) const;
    mutable TiXmlAttributeSet attributeBuckets[NumAttributeBuckets];
};


/**	An XML comment.
*/
class CAL3D_API TiXmlComment : public TiXmlNode {
public:
...
*/
class CAL3D_API TiXmlText : public TiXmlNode {
    friend class TiXmlElement;
public:
    /// Constructor.
...
*/
class CAL3D_API TiXmlDeclaration : public TiXmlNode {
public:
...
TiXmlElement* NewTiXmlElement();
TiXmlComment* NewTiXmlComment();
TiXmlText* NewTiXmlText();
